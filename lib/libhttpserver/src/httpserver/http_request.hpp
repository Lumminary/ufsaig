...
class http_request
{
    ...
    private:
        ...
        **/
        ...
        {
            size_t max = std::min(new_content.size(), content_size_limit);
            std::string::const_iterator begin = new_content.begin();
            std::string::const_iterator end = begin + max;
            set_content(begin, end);
        }

        /**
         * Method used to set the content of the request
         * @param begin Beginning of the content to set.
         * @param end End of the content to set.
        **/
        template<typename char_iter>
        void set_content(char_iter begin, char_iter end)
        {
            this->content.assign(begin, end);
        }
        ...
        **/
        ...
        {
            this->content.insert(this->content.end(), content, content + size);
